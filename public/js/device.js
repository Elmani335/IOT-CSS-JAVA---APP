...
(function(window){
	...
	function getId() {
		...
		window.deviceId = prompt("Enter a unique ID for RED335 App of at least 8 characters containing only letters and numbers (Warning : it will be displayed on the dashboard!):");
